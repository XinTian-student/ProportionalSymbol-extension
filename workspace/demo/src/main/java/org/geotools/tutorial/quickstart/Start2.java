...
public class Start2 {
    ...
    public static void main(String[] args) throws Exception {
        //open the polygon and point vector data
        ...
        map.setTitle("The population of each Municipality in Overijssel Province");

        //open the style file
        //parse this style file
        ...
        //Match style files and vector data
        Layer layer1 = new FeatureLayer(polygonfeature, style);
        Layer layer2 = new FeatureLayer(pointfeature, style);
        
        //render layers, call the evaluate function of the ProportionalSymbolFunction class
        map.addLayer(layer2);
        map.addLayer(layer1);
